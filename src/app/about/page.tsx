  ...
  return (
    <main className="max-w-2xl mx-auto px-6 pt-16 pb-32">
              ...
              >
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <span className="text-[10px] bg-neutral-100 px-1.5 py-0.5 rounded uppercase font-bold text-neutral-500 tracking-wider">
                      {project.tag}
                    </span>
                  </div>
                ...
                <PixelArrowIcon
                  size={16}
                  className="text-neutral-300 group-hover:text-black transition-colors mt-0.5"
                />
              </Link>
            </div>
          ))}
          ...
          {experiences.map((exp) => (
            <div key={exp.company}>
              <div className="flex items-start justify-between mb-1">
                ...
                <span className="text-xs text-neutral-300 font-mono shrink-0 ml-4">
                  {exp.period}
                </span>
              </div>
      ...
      <section className="pt-8 border-t border-neutral-100 flex items-center space-x-6">
        ...
        <Link
          href="https://github.com/ycanerden"
          target="_blank"
          className="text-muted hover:text-black transition-colors"
        >
          <Github size={20} />
        ...
        <Link
          href="https://www.linkedin.com/in/can-erden/"
          target="_blank"
          className="text-muted hover:text-black transition-colors"
        >
          <Linkedin size={20} />
